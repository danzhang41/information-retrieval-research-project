...
def process_dataset(json_path, select_cols, train_rate, csv_path):
    ...
    #df.columns = ['userID', 'itemID', 'rating', 'review'] 
    ...
    #copy('csv/temp_train.csv', 'csv/train.csv')
    #copy('csv/temp_valid.csv', 'csv/valid.csv')
    #copy('csv/temp_test.csv', 'csv/test.csv')
...
def copy(src_path, dest_path):
    with open(src_path, 'r') as src, open(dest_path, 'w') as dest:
        ...
        writer.writerows(line.split() for line in src)
